...
// style the source link button dynamically
  ...
  return (
    <div className="card w-75 box-shadow mb-4">
      <div className="card-body mx-xl-4 mx-lg-4 mx-md-2 mx-sm-1 mx-xs-1 py-xl-3 py-lg-3 my-xl-3 my-lg-3">
        <h2 className="card-title py-1">{props.idea.title}</h2>
        <p className="card-text lead pt-1 pb-2">{props.idea.content}</p>
